...
export const AI_MODELS = {
  "gpt-4o": {
    ...
    description:
      "Our high-intelligence flagship model for complex, multi-step tasks. GPT-4o is cheaper and faster than GPT-4 Turbo.",
  ...
  "gpt-4o-mini": {
    ...
    description:
      "Our affordable and intelligent small model for fast, lightweight tasks. Cheaper and more capable than GPT-3.5 Turbo.",
    contextWindow: 128000,
