<!-- ThemeToggle.svelte - Theme toggle button component -->
<script lang="ts">
  import { themeStore } from './themeStore.svelte';
  
  // Local state to avoid frequent rerendering
...
<button 
  ...
  class="p-2 rounded-full hover:bg-surface-800/50 transition-colors"
  onclick={toggleTheme}
>
